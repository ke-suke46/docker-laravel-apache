    ...
    <div class="card-header">
        <div class="col-sc d-flex flex-row justify-content-between ">
            <form method="get" action="{{ route('home') }}">
                ...
                <div type="button" class="input-group-text"><a class="text-white" href="{{ route('home')}}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search mr-2" viewBox="0 0 16 16">
